...
extension OpenAPI.Components {
    internal mutating func externallyDereference<Loader: ExternalLoader>(with loader: Loader.Type, depth: ExternalDereferenceDepth = .iterations(1), context: [Loader.Message] = []) async throws -> [Loader.Message] {
        ...
        async let (newResponses, c2, m2): (OpenAPI.ComponentDictionary<OpenAPI.Response>, OpenAPI.Components, [Loader.Message]) = oldResponses.externallyDereferenced(with: loader)
        async let (newParameters, c3, m3): (OpenAPI.ComponentDictionary<OpenAPI.Parameter>, OpenAPI.Components, [Loader.Message]) = oldParameters.externallyDereferenced(with: loader)
        async let (newExamples, c4, m4): (OpenAPI.ComponentDictionary<OpenAPI.Example>, OpenAPI.Components, [Loader.Message]) = oldExamples.externallyDereferenced(with: loader)
        async let (newRequestBodies, c5, m5): (OpenAPI.ComponentDictionary<OpenAPI.Request>, OpenAPI.Components, [Loader.Message]) = oldRequestBodies.externallyDereferenced(with: loader)
        async let (newHeaders, c6, m6): (OpenAPI.ComponentDictionary<OpenAPI.Header>, OpenAPI.Components, [Loader.Message]) = oldHeaders.externallyDereferenced(with: loader)
        async let (newSecuritySchemes, c7, m7): (OpenAPI.ComponentDictionary<OpenAPI.SecurityScheme>, OpenAPI.Components, [Loader.Message]) = oldSecuritySchemes.externallyDereferenced(with: loader)
...
//        async let (newCallbacks, c9, m9) = oldCallbacks.externallyDereferenced(with: loader)
        async let (newPathItems, c10, m10): (OpenAPI.ComponentDictionary<OpenAPI.PathItem>, OpenAPI.Components, [Loader.Message]) = oldPathItems.externallyDereferenced(with: loader)
