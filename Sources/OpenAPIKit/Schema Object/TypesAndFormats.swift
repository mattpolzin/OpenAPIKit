...
///
/// These are the OpenAPI [data types](https://spec.openapis.org/oas/v3.2.0.html#data-types)
...
/// section on [data types](https://spec.openapis.org/oas/v3.2.0.html#data-types).
...
///
/// See "formats" under the OpenAPI [data type](https://spec.openapis.org/oas/v3.2.0.html#data-types)
/// documentation.
