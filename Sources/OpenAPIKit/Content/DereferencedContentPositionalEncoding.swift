//
//  DereferencedContentPositionalEncoding.swift
//
//
...
public struct DereferencedPositionalEncoding: Equatable {
    ...
    /// Encoding Object.
    public var prefixEncoding: [DereferencedContentEncoding]
    ...
    /// behavior is determined by the default values documented for the
    /// Encoding Object.
    public var itemEncoding: DereferencedContentEncoding?

    public init(
        prefixEncoding: [DereferencedContentEncoding] = [],
        itemEncoding: DereferencedContentEncoding? = nil
    ) {
