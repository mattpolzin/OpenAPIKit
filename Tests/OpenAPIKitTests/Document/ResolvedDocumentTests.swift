...
final class ResolvedDocumentTests: XCTestCase {
    ...
    func test_documentWithOneRouteWithMultipleEndpoints() throws {
        ...
        XCTAssert(try XCTUnwrap(t1.routesByPath["/hello/world"]).endpoints.contains { $0.operationSummary == "Get world" })
        XCTAssert(try XCTUnwrap(t1.routesByPath["/hello/world"]).endpoints.contains { $0.operationSummary == "Create world" })
    ...
    public func test_documentWithTwoRoutesEachWithTwoEndpoints() throws {
        ...
        XCTAssert(try XCTUnwrap(t1.routesByPath["/hello/universe"]).endpoints.contains { $0.operationSummary == "Get universe" })
        XCTAssert(try XCTUnwrap(t1.routesByPath["/hello/universe"]).endpoints.contains { $0.operationSummary == "Create universe" })
