...
final class ResolvedRouteTests: XCTestCase {
    func test_takesOnPathProperties() throws {
        ...
        XCTAssertEqual(routes.first?.get?.operationSummary, "get")
        XCTAssertEqual(routes.first?.put?.operationSummary, "put")
        XCTAssertEqual(routes.first?.post?.operationSummary, "post")
        XCTAssertEqual(routes.first?.delete?.operationSummary, "delete")
        XCTAssertEqual(routes.first?.options?.operationSummary, "options")
        XCTAssertEqual(routes.first?.head?.operationSummary, "head")
        XCTAssertEqual(routes.first?.patch?.operationSummary, "patch")
        XCTAssertEqual(routes.first?.trace?.operationSummary, "trace")
