...
extension OperationTests {
    ...
    static let __allTests__OperationTests = [
        ("test_init", test_init),
        ("test_responseOrder_decode", test_responseOrder_decode),
        ("test_responseOrder_encode", test_responseOrder_encode),
    ]
}
...
extension OrderedDictionaryTests {
    ...
    static let __allTests__OrderedDictionaryTests = [
        ...
        ("test_indexSubscriptGet", test_indexSubscriptGet),
        ("test_intKeyDecode2", test_intKeyDecode2),
        ("test_intKeyDecode", test_intKeyDecode),
        ...
        ("test_otherKeyEncode", test_otherKeyEncode),
        ("test_stringEnumKeyDecode2", test_stringEnumKeyDecode2),
        ("test_stringEnumKeyDecode", test_stringEnumKeyDecode),
        ("test_stringEnumKeyEncode", test_stringEnumKeyEncode),
        ("test_stringKeyDecode2", test_stringKeyDecode2),
        ("test_stringKeyDecode", test_stringKeyDecode),
        ("test_stringKeyEncode", test_stringKeyEncode),
    ]
}
